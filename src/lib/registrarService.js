import { getTomoChainProvider, getTomoChainRegistrarAddress } from './web3Service';
...
const setWeb3Provider = () => {
  ...
  registrar = new Registrar(web3, getTomoChainRegistrarAddress(process.env.TNS_NETWORK));
}
